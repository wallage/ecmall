...
'toseller_store_closed_notify' => '您的店铺已被关闭，原因是：{$reason}',
    ...
    'toseller_groupbuy_end_notify' => '请尽快到“已结束的团购”完成该团购活动，以便买家可以完成交易，如结束后{$cancel_days}天未确认完成，该活动将被自动取消,查看[url=index.php?app=seller_groupbuy&state=end]已结束的团购[/url]',
    ...
    'touser_send_coupon' => '优惠金额：{$price}' . "\r\n" . '有效期：{$start_time} 至{$end_time}' . "\r\n" . '优惠券号码：{$coupon_sn}' . "\r\n" . '使用条件：购物满 {$min_amount} 即可使用' . "\r\n" . '店铺地址：[url={$url}]{$store_name}[/url]',
    'tobuyer_groupbuy_finished_notify' => '“{$group_name}”活动成功完成，请尽快购买活动商品。[url=index.php?app=order&goods=groupbuy&group_id={$id}]点此购买[/url]',
    ...
    'code_example' => "字体加粗：[b]加粗[/b]<br />图片标签：[img]http://www.baidu.com/img/baidu_logo.gif[/img]<br/>超链接标签：[url=www.baidu.com]www.baidu.com[/url]<br/>引用标签：[quote]ECMall[/quote]<br />代码标签：[code]array('2222','3333')[/code]",
);
?>
